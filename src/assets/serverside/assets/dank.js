...
exports.run = (URL) => {
  return new Promise(async(resolve, reject) => {
    ...
    const overlay = await Jimp.read('./resources/dank/red.png').catch(reject)
    const hit = await Jimp.read('./resources/dank/hit.png').catch(reject)
    const gun = await Jimp.read('./resources/dank/gun.png').catch(reject)
    const faze = await Jimp.read('./resources/dank/faze.png').catch(reject)
