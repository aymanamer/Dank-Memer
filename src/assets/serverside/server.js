...
app.get('/api/*', async(req, res) => {
  ...
  if (!req.headers['api-key'] || !keys.includes(req.headers['api-key'])) { return res.status(401).send('<h1>401 - Unauthorized</h1><br>You are not authorized to access this endpoint.') }
