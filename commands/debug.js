	...
	setTimeout(async function () {
		...
		await msg.channel.send({
			embed: new Discord.RichEmbed()
				...
				.addField('Blacklisted Users', bl.people.length, true)
				.addField('Blacklisted Servers', bl.servers.length, true)
				.addField('Donor Count', config.donor1.length + config.donor5.length + config.donor10.length, true)
